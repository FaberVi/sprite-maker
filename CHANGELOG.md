...
- Workspace initialization preflights Python (`py -3`, `python3`, or `python`), writes `.sprite-studio/python_launcher.json`, warns in Settings and after create/open when Python is missing, and injects the resolved command into generation prompts.
